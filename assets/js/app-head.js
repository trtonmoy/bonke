...
const isDarkMode = () => document.documentElement.classList.contains("uk-dark"),
    setDarkMode = (e = !0) => {
        document.documentElement.classList.contains("uk-dark") !== e && (e ? document.documentElement.classList.add("uk-dark") : document.documentElement.classList.remove("uk-dark"), window.dispatchEvent(new CustomEvent("darkmodechange")))
    };
...
const ENABLE_PAGE_REVEALER_USED = "show" === localStorage.getItem("page-revealer"); {
    ...
    document.addEventListener("click", (async o => {
        ...
        s && s instanceof HTMLAnchorElement && !o.defaultPrevented && a(s) && (o.preventDefault(), n.style.transition = "transform " + t + "s " + e, n.style.visibility = "visible", n.style.transform = "scaleY(1)", n.style.transformOrigin = "center bottom", await new Promise((e => setTimeout(e, 1e3 * t))), localStorage.setItem("page-revealer", "show"), location.href = s.href)
    }))
}