...
document.body.classList.toggle("uni-is-login", "1" === localStorage.getItem("is-login")), document.querySelectorAll(".uni-login-form, .uni-signup-form").forEach((t => {
    ...
    t.addEventListener("click", (async t => {
        t.preventDefault(), localStorage.removeItem("is-login"), location.reload()
    }))
})); {
    class t {
        constructor(t) {
            this.dd = t, this.placeholder = this.dd.find("span"), this.opts = this.dd.find(".uk-droplist-dropdown li"), this.val = "", this.index = -1, this.initEvents(), this.onChangeHandlers = new Set
        }
        initEvents() {
            const t = this;
            t.dd.on("click", (function(t) {
                t.preventDefault(), t.stopPropagation(), $(this).toggleClass("uk-active")
            })), t.opts.on("click", (function() {
                const e = $(this);
                t.val = e.text(), t.index = e.index(), t.placeholder.text(t.val), e.siblings().removeClass("uk-active"), e.filter(':contains("' + t.val + '")').addClass("uk-active"), t.dd.trigger("change")
    ...
    t.forEach((t => {
        ...
        t.addEventListener("mouseover", (() => {
            n.setAttribute("src", r), n.classList.add("uk-active"), s = Date.now(), l = !0, clearTimeout(i)
            ...
            const i = n.clientWidth,
                r = n.clientHeight;
            o + i >= window.scrollX + window.innerWidth - e && (a ? o -= i : o = window.innerWidth - e - i), s + r >= window.scrollY + window.innerHeight && (a ? s -= r : s = window.scrollY + window.innerHeight - r), n.style.setProperty("--move-x", o + "px"), n.style.setProperty("--move-y", s + "px")
        })), t.addEventListener("mouseleave", (() => {
            const t = Date.now() - s;
            i = setTimeout((() => {
                n.classList.remove("uk-active"), i = setTimeout((() => {
                    l = !1, n.style.setProperty("--move-x", "0px"), n.style.setProperty("--move-y", "0px")
                }), o)
            }), Math.max(0, o - t))
        }))
    }))
...
const stickyItemContrast = (t, e, o, a = {}) => {
        ...
        const l = () => {
            ...
            const r = (t => {
                    let e = "";
                    for (; t && (e = window.getComputedStyle(t, null).getPropertyValue("background-color"), /rgba\(.*?,\s*0\)$/.test(e));) t = t.parentElement;
                    return e
                })(t[l]),
                d = n(r);
            i !== d && a[i] && e.classList.remove(a[i]), a[d] && e.classList.add(a[d]), i = d
        };
    ...
    stickyItemsDarkMode = (t, e) => {
        ...
        for (const t of a) stickyItemContrast(o, t, e, {
            black: "",
            white: "uk-dark"
        })
    };
stickyItemsDarkMode(".uni-header, .uni-sticky-menu, .uni-header-social", (t => t.offsetTop + t.clientHeight / 2)), stickyItemsDarkMode(".uni-header-location, .uni-header-section-indicator", (() => window.innerHeight / 2)); {
    ...
    if (t) {
        ...
        const n = () => {
            const o = window.innerHeight / 2,
                n = e.map((t => t instanceof HTMLElement && window.scrollY + o >= t.offsetTop)).lastIndexOf(!0); - 1 !== n && a !== n && (a = n, t.style.setProperty("--section-indicator-index", a + ""))
        };
...
document.querySelectorAll("[data-darkmode-toggle] input").forEach((t => {
    ...
    $(".search-form").each((function() {
        ...
        o.on("submit", (t => {
            ...
            const e = a.val();
            c || (c = !0, l.removeClass("uk-hidden"), i.addClass("uk-hidden")), m(), e ? n.removeClass("uk-hidden") : n.addClass("uk-hidden"), !g && e ? p() : g && !e && (h(), i.addClass("uk-hidden"))
        })), n.on("click", (t => {
            a.val("").trigger("input")
        })), a.on("focus", (t => {
            a.val() && (g || p())
...
document.addEventListener("DOMContentLoaded", (t => {
    $("[data-toggle-active]").on("click", (function(t) {
        t.preventDefault();
        const e = $(this);
        e.toggleClass("active").hasClass("active") ? (e.removeClass(e.attr("data-not-active-class")), e.addClass(e.attr("data-active-class"))) : (e.removeClass(e.attr("data-active-class")), e.addClass(e.attr("data-not-active-class")))
    }))
})), $("[data-toggle-loading]").on("click", (function(t) {
    t.preventDefault();
    const e = this,
        o = $(this);
    if (o.hasClass("loading") || o.hasClass("no-more-loading") || !e.toggleLoadingClick || !e.toggleLoadingInsertData) return;
    o.addClass("loading"), o.addClass(o.attr("data-loading-class")), o.removeClass(o.attr("data-not-loading-class"));
    const a = e.toggleLoadingClick();
    setTimeout((() => {
        a.then((t => {
            e.toggleLoadingInsertData(t) ? (o.attr("disabled", ""), o.removeClass("loading"), o.addClass("no-more-loading"), o.removeClass(o.attr("data-loading-class")), o.addClass(o.attr("data-no-more-loading-class"))) : (o.removeClass("loading"), o.removeClass(o.attr("data-loading-class")), o.addClass(o.attr("data-not-loading-class")))
        }))
    }), 500)
    ...
    let n = 1;
    e.toggleLoadingClick = () => (console.log("url", a), fetch(a.replace(/%page%/g, ++n + "")).then((t => t.text()))), e.toggleLoadingInsertData = t => {
        if (t = t.replace(/<script type="module" src="\/@vite\/client"><\/script>/, ""), o.insertAdjacentHTML("beforeend", t), !t.trim()) return !0
    }
}));
var playing = !1;
$("#uni-audio-play-pause").on("click", (function(t) {
    t.preventDefault(), $(this).find(".uni-icon-bars").toggleClass("playing"), 0 == playing ? (document.getElementById("uni-background-audio").play(), playing = !0) : (document.getElementById("uni-background-audio").pause(), playing = !1)
}));