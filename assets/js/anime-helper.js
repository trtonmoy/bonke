{
    const e = "undefined" != typeof jQuery ? jQuery : null,
        ...
        r = (e, r) => {
            ...
            for (const a of e.split(";")) {
                ...
                let g = o;
                c.forEach(((e, t) => {
                    t < c.length - 1 ? (g[e] = g[e] || {}, g = g[e]) : g[e] = l
                }))
            }
            return o
        },
        ...
        a = (e, t, n = "restart") => {
            if ("alternate" === n) e.animeToggleOpen ? t.reversed || t.reverse() : t.reversed && t.reverse(), e.animeToggleOpen = !e.animeToggleOpen, t.play();
            else if ("restart" === n) t.restart();
            else {
                if ("reset" !== n) throw "invalid direction";
                t.reset()
            }
        },
        s = new Promise((e => {
        ...
        l = async (t, n, r) => {
            ...
            if (n.onclick) {
                ...
                t.addEventListener("click", (t => {
                    t.preventDefault(), o(e ? "alternate" : "restart")
                })), i = !1
            }
            if (n.onscroll) {
                ...
                e.target && (e.triggerElement = e.target, delete e.target);
                const o = new ScrollMagic.Controller({ ...e.controller || {}
                    }),
                    a = e.pen;
                delete e.controller, delete e.pen;
                const s = e || {},
                ...
                })).addTo(o), delete n.onscroll, i = !1
            }
            if (n.onhover && (e(t).on("mouseenter mouseleave", (() => {
                    o("alternate")
                })), i = !1), await s, void 0 !== n.onview && !1 !== n.onview) {
                const e = "number" == typeof n.onview ? n.onview : 0,
                    r = () => {
                        window.innerHeight > t.getBoundingClientRect().top - e && (window.removeEventListener("scroll", r), window.removeEventListener("resize", r), o())
                    };
                window.addEventListener("scroll", r), window.addEventListener("resize", r), r(), i = !1
            }
            if (n.media) {
        ...
        c = async t => {
            ...
            if (Object.assign(n, {
                ...
                const e = n.timeline;
                delete n.timeline, g[e] || (d[e] || (d[e] = new Promise((t => {
                    m[e] = t
                }))), await d[e]), a = g[e](t, n)
            } else a = anime(n);
            a.pause(), t.animeInstance = a, l(t, n, a)
        },
        g = {},
        d = {},
        m = {},
    ...
    dataAttrHelpers.watchDataAttr("data-anime", c), dataAttrHelpers.watchDataAttr("data-anime-toggle", u)
}